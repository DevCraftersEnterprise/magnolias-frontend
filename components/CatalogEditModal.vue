<!-- components/CatalogEditModal.vue -->
<template>
    <BaseModal v-model="open">
      ...
      <div class="space-y-3">
        ...
        <div>
          <label class="block text-[12px] font-semibold text-gray-600 mb-1">Descripción</label>
          <textarea
  ...
  function submit() {
    emit('save', { id: local.id, name: local.name, description: local.description })
  }
  </script>