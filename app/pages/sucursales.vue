<template>
  ...
  >
    <img src="/svg/flower-tl.svg" alt="" class="pointer-events-none absolute top-0 left-0 w-48 opacity-20" />
    <img src="/svg/flower-tl.svg" alt="" class="pointer-events-none absolute top-0 right-0 w-48 opacity-20 scale-x-[-1]" />
    <h1 class="relative font-serif text-4xl sm:text-5xl text-[#1E1E1E]">Nuestras Sucursales</h1>
    <p class="relative mt-3 text-sm sm:text-base text-[#1E1E1E]/60 max-w-md mx-auto">
  ...
  <section class="py-12 px-5 bg-white">
    <div class="mx-auto max-w-6xl">
      ...
      <div v-if="loading" class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div v-for="n in 3" :key="n" class="bg-white rounded-2xl shadow p-5 animate-pulse space-y-3">
      ...
      <!-- Sin sucursales -->
      <div v-else class="rounded-2xl bg-[#FFF0F7] border border-[#F472B6]/20 p-16 text-center">
        <div class="text-5xl mb-4">📍</div>
        <p class="text-[#1E1E1E]/40 text-sm">No hay sucursales disponibles por el momento.</p>
      </div>
