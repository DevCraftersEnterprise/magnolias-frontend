          ...
          <div class="relative mt-1">
            ...
            >
              ...
              <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.97 9.97 0 012.255-3.592M6.228 6.228A9.97 9.97 0 0112 5c4.477 0 8.268 2.943 9.542 7a9.97 9.97 0 01-4.254 5.275M3 3l18 18" />
              </svg>
            </button>
          </div>
        </div>
  ...
  try {
    ...
    if (props.mode === 'create') {
      ...
      if (form.role === 'BAKER') {
        ...
        if (form.specialty.trim()) editPayload.specialty = form.specialty.trim()
      }
