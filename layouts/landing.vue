<template>
  <div class="min-h-screen flex flex-col bg-white">
      ...
      >
        ...
        >
          ...
          <NuxtLink to="/" class="flex justify-center">
            <img src="/img/magnolias-logo.png" alt="Magnolias" class="h-10 w-auto" />
          </NuxtLink>
    ...
    <footer class="bg-[#1E1E1E] text-white">
      <div class="mx-auto max-w-2xl px-5 py-12 flex flex-col items-center gap-5">
        <img src="/img/magnolias-logo.png" alt="Magnolias" class="h-12 w-auto brightness-0 invert" />
        ...
        <p class="text-xs text-white/25 text-center">
          © {{ new Date().getFullYear() }} Pastelería Magnolias &nbsp;|&nbsp; Todos los derechos reservados
        </p>
      </div>
    </footer>
  </div>
