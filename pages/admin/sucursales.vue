...
<template>
    <div class="px-6 py-6">
        ...
        <div v-if="branches.length > 0" class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div v-else-if="!loading && !errorMsg" class="mt-12 flex flex-col items-center justify-center gap-3 text-center">
            <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-black/5">
                <svg class="h-7 w-7 text-[#9CA3AF]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                </svg>
            </div>
            <p class="text-[15px] font-semibold text-[#111827]">Sin sucursales registradas</p>
            <p class="text-[13px] text-[#6B7280]">Agrega la primera sucursal usando el botón de arriba.</p>
        </div>
    </div>
